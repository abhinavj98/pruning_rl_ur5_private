...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "optical_flow = follow_the_leader.optical_flow:main",
            "optical_flow_srv = follow_the_leader.optical_flow_srv:main",
            "goal_publisher = follow_the_leader.goal_publisher:main",
            "controller_rl = follow_the_leader.controller_rl:main",
