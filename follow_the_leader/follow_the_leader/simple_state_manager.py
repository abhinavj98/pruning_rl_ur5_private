...
class SimpleStateManager(Node):
    def __init__(self):
        ...
        self.get_logger().debug('Received stsdas')
        # ROS2 params
        ...
        #These are the services that are called by the state machine to switch to velocity control
        ...
        self.transition_table = {
            ...
            (States.VISUAL_SERVOING, States.IDLE): {},
    ...
    def handle_state_announcement(self, msg: States):
        new_state = msg.state
        self.get_logger().debug('Received state announcement: {}'.format(new_state))
        # print("[DEBUG] Received state announcement: {}".format(new_state))
